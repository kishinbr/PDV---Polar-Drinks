        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FornecedorNome = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    ...
                    FornecedorEmail = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    ...
                    FornecedorLogradouro = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProdutoDescricao = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VendaTipoPagamento = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MovimentacaoDescricao = table.Column<string>(type: "nvarchar(max)", nullable: true),
